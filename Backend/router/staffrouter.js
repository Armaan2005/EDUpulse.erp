...
const { staffregister, stafflogin, staffprofile, stafflogout, viewstaff,deletestaff ,updatestaff,viewbyid, staffupdate} = require("../controller/staffcontroller");
router.post("/staffregister",auths,upload.single("image"),staffregister);
...
router.get("/viewbyidstaff/:id",viewbyid);
router.put("/staffupdate",auth,upload.single("image"),staffupdate);
