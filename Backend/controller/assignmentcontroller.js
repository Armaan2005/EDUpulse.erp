const { create,view,submission, viewsubmission,assfeedback,viewassfeedback, findSubmissionById, studentViewSubmission } = require("../service/assignmentservice");
...
{
    await studentViewSubmission(req,res);
}