...
import ViewStaffAttendance from './Pages/ViewStaffAttendance'
import ViewStuAttendance from './Pages/ViewStuAttendance'
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/ViewStuAttendance' element={<ViewStuAttendance/>}/>
