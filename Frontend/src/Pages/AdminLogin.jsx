...
import { 
    AdminPanelSettings, Email, Lock, Visibility, VisibilityOff, ArrowForward 
        ...
        >
            ...
            >
                ...
                <Box sx={{ textAlign: 'center', mb: 4, mt: 2 }}>
                    <AdminPanelSettings sx={{ fontSize: 65, color: secondaryColor, mb: 1.5, border: `2px solid ${secondaryColor}`, borderRadius: '50%', p: 1 }} />
                    <Typography 
                        variant="h4" 
                        component="h1" 
