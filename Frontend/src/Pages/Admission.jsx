...
const Admission = () => {
  ...
  const handleStepOneSubmit = (e) => {
    e.preventDefault();
    if (studentDetails.name && studentDetails.email && studentDetails.phone && studentDetails.department) {
      setStep(2);
      setStatus(null);
    } else {
      setStatus({
        type: 'error',
        message: 'Please fill in all required student details, and select a department.',
      });
    }
  };
            ...
            <div>
              ...
              <div className="department-card">
                <h3 className="department-title">
                  ...
                  Department: {
                    studentDetails.department || 'Not selected'
                  }
                </h3>
